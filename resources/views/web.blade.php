        ...
        <div class="container">
            <div class="about-me" style="color:rgb(255,255,255);">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="/tools/web">Web</a></li>
                </ul>
                ...
                <a href="{{ $web->link }}" style="text-decoration: none; color: inherit;">
                <p class="text-left" style="font-size:16px; font-weight:bold; margin-bottom: 0.5em;">{{ $web->title }}</p>
                <p class="text-left" style="font-size:16px; color: #d4d4d4;"> · {{ $web->description }}</p>
                </a>
